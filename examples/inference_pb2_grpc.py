...
class InferenceServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.StreamInference = channel.unary_stream(
            "/modelmora.InferenceService/StreamInference",
...
def add_InferenceServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler("modelmora.InferenceService", rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers("modelmora.InferenceService", rpc_method_handlers)
